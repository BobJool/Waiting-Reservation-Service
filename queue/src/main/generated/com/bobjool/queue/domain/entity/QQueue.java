...
public class QQueue extends EntityPathBase<Queue> {
	...
	public final com.bobjool.common.domain.entity.QBaseEntity _super = new com.bobjool.common.domain.entity.QBaseEntity(
		this);
	...
	public final EnumPath<com.bobjool.queue.domain.enums.DiningOption> diningOption = createEnum("diningOption",
		com.bobjool.queue.domain.enums.DiningOption.class);
	...
	public final EnumPath<com.bobjool.queue.domain.enums.QueueStatus> status = createEnum("status",
		com.bobjool.queue.domain.enums.QueueStatus.class);

	public final EnumPath<com.bobjool.queue.domain.enums.QueueType> type = createEnum("type",
		com.bobjool.queue.domain.enums.QueueType.class);
